...
-e "osrelease=${OSRELEASE}" -e "repo_version=${REPO_VERSION}" \
  ...
  -e "install_idm=htpasswd" -e "## SB Don't set software_to_deploy from here, always use extra vars (-e) or "none" will be used
...
#software_to_deploy:=openshift" -e "osrelease=3.5.5.15" -e "docker_version=1.12.6" \
