...
// Catalog items
def choices = [
    'OPENTLC OpenShift 4 Labs / OpenShift 4 Client VM',
    'DevOps Team Development / PREPROD OpenShift 4 Client VM',
].join("\n")
                ...
                script {
                    ...
                    guid = sh(
                        ...
                        script: """
                          ...
                          -i '${item}' \
                          -G '${cf_group}' \
                          -d 'status=t,notes=Development - Catalog item creation / maintenance,expiration=7,runtime=8,ocprelease=${ocprelease},region=${region},environment=${environment}'
                        """
                    ).trim()
