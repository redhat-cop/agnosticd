...
// Catalog items
def choices = [
    'OPENTLC OpenShift 4 Labs / OpenShift 4 AWS Install VM',
    'DevOps Deployment Testing / TEST OpenShift 4 AWS Install VM',
    'DevOps Team Development / DEV OpenShift 4 AWS Install VM',
].join("\n")
