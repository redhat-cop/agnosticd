                ...
                script {
                    ...
                    guid = sh(
                        ...
                        script: """
                          ...
                          -i '${item}' \
                          -G '${cf_group}' \
                          -d 'status=t,notes=Development - Catalog item creation / maintenance,expiration=7,runtime=8,ocprelease=${ocprelease},region=${region},nodes=${nodes},environment=${environment}'
                        """
                    ).trim()
