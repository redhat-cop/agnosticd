...
// Catalog items
def choices = [
    'OPENTLC OpenShift 4 Labs / OpenShift 4 Installation Lab',
    'DevOps Deployment Testing / TEST OpenShift 4 Installation Lab',
    'DevOps Team Development / DEV OpenShift 4 Installation Lab',
].join("\n")
                ...
                script {
                    ...
                    guid = sh(
                        ...
                        script: """
                          ...
                          -i '${item}' \
                          -G '${cf_group}' \
                          -d 'status=t,notes=Development - Catalog item creation / maintenance,expiration=6,runtime=8,region=${region}'
                        """
                    ).trim()
