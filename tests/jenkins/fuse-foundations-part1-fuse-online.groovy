...
// Catalog items
def choices = [
    'OPENTLC Middleware Solutions Labs / Fuse Foundations Part 1 - Fuse Online',
].join("\n")
                ...
                script {
                    ...
                    guid = sh(
                        ...
                        script: """
                          ...
                          -i '${item}' \
                          -G '${cf_group}' \
                          -d 'status=t,notes=Development - Catalog item creation / maintenance,check=t,expiration=7,runtime=8,quotacheck=t,region=${region},nodes=${nodes}'
                        """
                    ).trim()
