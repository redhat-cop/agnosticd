...
// Catalog items
def choices = [
    'OPENTLC Automation / Ansible Foundations - Networking Lab',
    'OPENTLC Automation / Ansible Networking Lab - Testing',
    'OPENTLC Automation / DEV Ansible Foundations - Networking Lab',
].join("\n")
