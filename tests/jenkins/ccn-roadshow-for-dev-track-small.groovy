                ...
                script {
                    ...
                    guid = sh(
                        ...
                        script: """
                          ...
                          -i '${item}' \
                          -G '${cf_group}' \
                          -d 'status=t,notes=Development - Catalog item creation / maintenance,quotacheck=t,check=t,city=jenkins,region=${region},salesforce=gptejen,users=5,use_letsencrypt=f,expiration=2,runtime=24,notes=devops_automation_jenkins,course_module_list=m1\\,m2\\,m3\\,m4'
                        """
                    ).trim()
