...
(...)
---
You will be instructed to login to the cluster later, having the oc client installed will enable you to verify your results via command line, as well as the already available graphical console.
