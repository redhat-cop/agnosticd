...
We recommend creating this file and including it FIRST in the order of `ansible-playbook -e @nstead of using environment variables or `ansible-playbook -e` values.
===
...
Go onto the next lab, where you will start creating, modifying, and deleteing OpenShift resources, and sending debug information to your customers/students.
