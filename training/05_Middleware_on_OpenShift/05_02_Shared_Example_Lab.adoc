...
We'll be changing the value of the `ocp4_workload_example_shared_cluster_project_name` variable during our workload development.
...
ocp4_workload_example_shared_cluster_project_name: "example-default-{{ ocp_username }}" <2>
----
