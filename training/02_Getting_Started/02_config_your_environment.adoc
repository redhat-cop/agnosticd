...
= How to set up your laptop to develop with AgnosticD [[configs-laptop]]

This document is aimed to be a reference on how to setup your laptop (both Linux and Mac OS) for Ansible Agnostic Deployer development with OpenStack, AWS, and Azure.
