...
. Browse to the Domain name or IP address in 3 `osp_auth_url` omitting everything from the ":" (in case of a Red Hatter, you can also use the generic URL, http://YOUR_HORIZON_URL).
