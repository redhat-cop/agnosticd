...
TIP: You can simply register with your RHN credentials (user and password and a pool id). However, that is not very secure, so it's better to simply create your own activation key in link:https://access.redhat.com/[https://access.redhat.com/]
...
>>>>>>> 5ba62df5360aef4627d79ae2e1da65a52ba374f3
=======
>>>>>>> 4a97edbe7ca1fd0df3b708a01a5880a47ebfd463
>>>>>>> 3b7fe9a5934c6ff6a264233ea506205070cb3c8c
