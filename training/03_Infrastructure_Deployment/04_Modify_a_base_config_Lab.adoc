...
TIP: You can simply register with your RHN credentials (user and password). However, that is not very secure, so it's better to simply create your own activation key in link:https://access.redhat.com/[https://access.redhat.com/]
