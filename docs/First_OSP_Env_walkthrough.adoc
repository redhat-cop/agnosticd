...
NOTE: In order for the playbook to complete exectution succesfully, you will need a couple of things:
1. Some variables for your secret.yml file, you need to ask OPENTLC Admin
2. Install openstacksdk on your machine (further info at https://docs.openstack.org/openstacksdk/latest/user/[https://docs.openstack.org/openstacksdk/latest/user/]
