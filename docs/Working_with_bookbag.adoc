...
=== Rebuilding Bookbags deployed on a Bastion

When improving a bookbag, it's often nice to deploy an environment with bookbag, and then iterate on the bookbag adoc while that cluster is running.

. Log into the bastion
. Find the bookbag project and set into it.
[source,bash]
----
oc get projects | grep bookbag
----
+
.Sample Output
----
rdk7x-bookbag                                                     Active
----
+
[source,bash]
----
oc project rdk7x-bookbag
----

. Update the buildconfig as you may need to, if you have a new fork, branch, etc.
[source,bash]
----
oc edit bc/bookbag
----
...
[source,bash]
----
oc start-build bookbag
----

. Watch the build logs
[source,bash]
----
oc logs bc/bookbag -f
----
...
. When it's up again, refresh your browser.
