...
This is a configuration guide of the packages and repos you need to install the tools

==== Prerequisites
For AWS, AgnosticD setup will require:
- Programmatic access account and password
- Route53 DNS Domain
...
$ aws --version
aws-cli/1.18.71 Python/2.7.5 Linux/3.10.0-1062.12.1.el7.x86_64 botocore/1.16.21
----
