...
In order to be able to deploy AgnosticD configs on AWS, you will need an IAM user into your AWS account. If you are new to AWS, you can find the instructions link:here[https://docs.aws.amazon.com/IAM/latest/UserGuide/id_users_create.html].
