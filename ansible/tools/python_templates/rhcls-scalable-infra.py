...
osptokyo.add_hard_drive(name='images', size=60, image='ScalableInfra - Disk Images')
...
ospparis = ravello.Vm(name="2OSP all-in-one Paris", tag="ospparis", boot_disk_size_GB=150, 
                     ...
                     num_cpus=4, mem_size=16)
ospparis.add_hard_drive(name='images', size=60, image='ScalableInfra - Disk Images')
...
ospnewyork = ravello.Vm(name="3OSP all-in-one NewYork", tag="ospnewyork", boot_disk_size_GB=150, 
                     ...
                     num_cpus=4, mem_size=16)
ospnewyork.add_hard_drive(name='images', size=60, image='ScalableInfra - Disk Images')
