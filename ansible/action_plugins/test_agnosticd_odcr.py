...
def test_reservation_match():
    ...
    r2_1 = {"instance_type": "m5.xlarge", "instance_count": 2}
...
def test_inject_reservation():
    ...
    testcases = [
        {"args": [[], r1], "result": [r1]},
        {"args": [[], r1, r1_1], "result": [r2]},
        {"args": [[r1], r1], "result": [r2]},
        {"args": [[r1], r1], "result": [r2]},
        {"args": [[], r1, r2, r4], "result": [r3, r4]},
        {"args": [[], r1, r2, r2_1, r4], "result": [r3, r2_1, r4]},
    ]
    for tc in testcases:
