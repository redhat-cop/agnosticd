...
The following variables can be used in your playbooks to connect to the NIOS instance. They will be added to the Tower `nios` inventory during deployment. See the `nios_provider` dictionary in the sample playbook below for an example of their use.
