...
*Three Tier App* _config_  whilst intended for the deployment of a three tier app is perhaps better described as "5 un-configured RHEL machines all exposed to the internet".
