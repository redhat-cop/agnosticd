...
ansible-playbook main.yml \
  ...
  -e "own_repo_path=${REPO_PATH}" -e"@../../secret.yml"


  -e "ANSIBLE_REPO_PATH | default('.') | default('.')=${DEPLOYER_REPO_PATH}" \
----
...
#  -e "ipa_host_password=${IPAPASS}"
  ...
  -e "osrelease=3.11.16" \
  -e "docker_version=1.13.1" \
  -e "ANSIBLE_REPO_PATH | default('.') | default('.')=${DEPLOYER_REPO_PATH}" 1>> $LOG_FILE 2>> $LOG_FILE
----
