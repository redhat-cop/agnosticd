...
`ansible-playbook -e @configs/ansible-tower-implementation/sample_vars.yml main.yml`

=== To Delete an environment
----

ansible-playbook -e @configs/ansible-tower-implementation/sample_vars.yml \ 
  configs/ansible-tower-implementation/destroy_env.yml 
