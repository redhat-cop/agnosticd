...
*ansible-middleware-workshop* is designed to create the infrastructure required to run the ansible middleware workshop.  The workshop content and instructions is located at https://github.com/deewhyweb/ansible-middleware-workshop
