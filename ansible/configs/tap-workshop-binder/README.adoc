...
*tap-workshop-binder* _config_ is used to do cross-cluster tasks
...
---
guid:               test-config-00
env_type:           tap-workshop-binder
cloud_provider:     none
...

----

== Developing with `tap-workshop-binder`
...
`ansible-playbook main.yml -e @my_sample_vars.yaml -e @configs/tap-workshop-binder/sample_vars.yml`
