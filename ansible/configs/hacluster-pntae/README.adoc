...
`ansible-playbook -e @configs/hacluster-pntae/sample_vars.yml main.yml`

=== To Delete an environment
----

ansible-playbook -e @configs/hacluster-pntae/sample_vars.yml \ 
  configs/hacluster-pntae/destroy_env.yml 
