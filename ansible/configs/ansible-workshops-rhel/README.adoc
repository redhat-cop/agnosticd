...
*ansible-workshops-rhel* is a more modern derivitive from the earlier *Three Tier App* _config_  
...
`ansible-playbook main.yml -e @configs/ansible-workshops-rhel/sample_vars_ec2.yml -e @<YOUR_SECRET_VARS.yml>`
