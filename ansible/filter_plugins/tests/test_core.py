...
def test_ec2_tags_to_equinix_metal_tags():
    testcases = [
        [
            ...
            ["AnsibleGroup=bastions", "ostype=linux"],
        ],
        [
            [
                {
...
def test_agnosticd_get_all_images():
    ...
    testcases = [
        ...
        [
            [predefined["image2"], "image1"],
            [predefined["image2"], predefined["image1"]],
        ],
...
def test_agnosticd_filter_out_installed_collections():
    testcases = [
        ...
        },
        {
            "requirements": {
                "collections": [
                    {"name": "amazon.aws", "version": "2.2.0"},
                    {"name": "ansible.posix", "version": "1.3.0"},
                    {"name": "community.general", "version": "4.6.1"},
                    {"name": "community.vmware", "version": "2.7.0"},
                    {"name": "google.cloud", "version": "1.0.2"},
                    {"name": "kubernetes.core", "version": "2.3.0"},
                    {"name": "openstack.cloud", "version": "1.7.2"},
                ],
                "roles": [
                    {
                        "name": "ftl-injector",
            ...
            "installed_collections": {
                "/usr/share/ansible/collections/ansible_collections": {
                    "community.general": {"version": "6.3.0"},
                    "community.aws": {"version": "5.2.0"},
                    "ansible.utils": {"version": "2.9.0"},
                    "ansible.netcommon": {"version": "4.1.0"},
                    "ansible.posix": {"version": "1.5.1"},
                    "amazon.aws": {"version": "5.2.0"},
                    "kubernetes.core": {"version": "2.4.0"},
                    "azure.azcollection": {"version": "1.14.0"},
                    "openstack.cloud": {"version": "2.0.0"},
                }
            },
            "result": {
                "collections": [
    ...
    for tc in testcases:
        assert (
            core.agnosticd_filter_out_installed_collections(
                tc["requirements"], tc["installed_collections"]
            )
            == tc["result"]
        )
