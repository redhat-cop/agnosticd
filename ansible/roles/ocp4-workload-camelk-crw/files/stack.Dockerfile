...
RUN wget -O /tmp/kamel.tar.gz https://github.com/apache/camel-k/releases/tag/${CAMELK_VERSION}/camel-k-client-1.0.0-RC1-linux-64bit.tar.gz && cd /usr/bin && tar -xvzf /tmp/kamel.tar.gz && chmod a+x /usr/bin/kamel && rm -f /tmp/kamel.tar.gz
