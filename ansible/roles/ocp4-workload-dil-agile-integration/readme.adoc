= ocp4-workload-dil-agile-integration: Day In the Life Workshop - Agile Integration
...
----
TARGET_HOST="bastion.94gtg.sandbox1785.opentlc.com"
OCP_USERNAME="lab-user"
WORKLOAD="ocp4-workload-dil-agile-integration"
GUID=5432
...
ansible-playbook --connection=local -i ${TARGET_HOST}, ./configs/ocp-workloads/ocp-workload.yml \
                 -e"ansible_python_interpreter=/Users/hguerrer/.pyenv/shims/python" \
...
----
TARGET_HOST="bastion.3edf.example.opentlc.com"
OCP_USERNAME="sjayanti-redhat.com"
WORKLOAD="ocp4-workload-dil-agile-integration"
GUID=5432
USER_COUNT=1
