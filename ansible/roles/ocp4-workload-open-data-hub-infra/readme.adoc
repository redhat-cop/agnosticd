= ocp4-workload-open-data-hub-infra - Deploy basic Open Data Hub environment infrastructure for workshops

Roles that depends on this infra

* link:../ocp4-workload-open-data-hub-student[ocp4-workload-open-data-hub-student] must be deployed prior to running this role
...
OCP_USERNAME=$(whoami)
WORKLOAD="ocp4-workload-open-data-hub-infra"
