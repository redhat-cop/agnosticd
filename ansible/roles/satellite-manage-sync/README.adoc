...
:script_file: files/sync_script_version_6.4.yml
...
for reference look at link:{main_file}[main.yml] , link:{version_file}[version_6.4.yml] and link:{script_file}[sync_script_version_6.4.yml] 
