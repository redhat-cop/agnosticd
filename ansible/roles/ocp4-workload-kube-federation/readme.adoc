...
* Other variables:
** *_kubefed_project*: The name of the project to create and install Kube Federation to. Default: `kube-federation-system`
** *_kubefed_project_display*: The display name of the project. Default: `KubeFed V2`
** *_kubefed_subscription_csv*: The ClusterServiceVersion to be deployed. Default: `kubefed-operator.v0.1.0`
** *_kubefed_federated_api_types*: An array of Kubernetes/OpenShift API objects to be federated. Default: [ namespaces, deployments.apps, ingresses.extensions, services, routes ]
