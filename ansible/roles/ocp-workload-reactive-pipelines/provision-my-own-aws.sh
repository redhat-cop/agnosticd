...
END_PROJECT_NUM=1
START_PROJECT_NUM=1
WORKLOAD="ocp-workload-reactive-pipelines"
...
function login() {
    ...
    echo -en "\nHOST_GUID=$HOST_GUID\n" >> $LOG_FILE
    oc login https://master.ocpmwdemo.com:8443 --token=CoFoguMn6NWLrdQwdtwthM_NtqbtosUdG-R_F9oRkpc
}
...
function executeAnsible() {
    TARGET_HOST="18.191.122.198"
    SSH_USERNAME="ec2-user"
    SSH_PRIVATE_KEY="ocp-aws-key.pem"
