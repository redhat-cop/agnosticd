= ocp4-workload-rhte-gitops-app-portability-verification - Verifies the correct deployment of GitOps RHTE 2019 Lab to OpenShift
...
* Other variables:
** *_argocd_project*: The name of the project to create and install Argo CD to. Default: `argocd`
** *_argocd_project_display*: The display name of the project. Default: `Argo CD`
** *_argocd_default_user*: The default user for accesing Argo CD
** *_argocd_default_user_password*: The password for the default Argo CD user
** *_argocd_release*: Version of Argo CD that will be deployed
** *_gogs_project*: The name of the project to create and install the Gogs server
** *_gogs_project_display*: The display name of the project. Default: `Gogs Git Server`
...
WORKLOAD="ocp4-workload-rhte-gitops-app-portability-verification"
GUID=1001
