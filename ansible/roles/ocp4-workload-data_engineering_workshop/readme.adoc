= ocp4-workload-data_engineering_workshop - Workshop workload for the Data Engineering on OpenShift workshop

This workshop workoad will create user(s) project to deploy link:http://opendatahub.io[Open Data Hub] v0.5.1.
