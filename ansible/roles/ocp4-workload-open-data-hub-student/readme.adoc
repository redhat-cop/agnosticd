= ocp4-workload-open-data-hub-student - Deploy basic Open Data Hub student environment for workshops

Dependent roles

* link:../ocp4-workload-open-data-hub-infra[ocp4-workload-open-data-hub-infra] must be deployed prior to running this role
...
OCP_USERNAME=$(whoami)
WORKLOAD="ocp4-workload-open-data-hub-student"
