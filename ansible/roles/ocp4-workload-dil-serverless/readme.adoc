= ocp4-workload-dil-serverless: A Day In the Life of a serverless developer on OpenShift
...
----
TARGET_HOST="bastion.93ac.sandbox464.opentlc.com"
OCP_USERNAME="hguerrer-redhat.com"
WORKLOAD="ocp4-workload-dil-serverless"
GUID=5432

# Provision a single user at cluster creation
USER_COUNT=1
# Support upm to 4 more users being added later
SUPPORTED_USER_COUNT=5
...
ansible-playbook -i ${TARGET_HOST}, ./configs/ocp-workloads/ocp-workload.yml \
                 ...
                 -e"ansible_user=${OCP_USERNAME}" \
                    ...
                    -e"num_supported_users=${SUPPORTED_USER_COUNT}" \
...
----
TARGET_HOST="bastion.c564.example.opentlc.com"
OCP_USERNAME="hguerrer-redhat.com"
WORKLOAD="ocp4-workload-dil-serverless"
GUID=5432
USER_COUNT=5
