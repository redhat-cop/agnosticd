= ocp4_workload_gitops_workshop - Deploy the assets required to run the GitOps (ArgoCD) Workshop

== Role overview

* Deploys the assets for the GitOps (ArgoCD) Workshop. It consists
