= ocp4_workload_advanced_gitops_workshop - Deploy the assets required to run the GitOps (ArgoCD) Workshop

== Role overview

* Deploys the assets for the Advanced GitOps (ArgoCD) Workshop. It consists
