= ocp4_workload_gitops_namespace_generator - Uses OpenShift GitOps to programmatically create namespaces

== Role overview

* This role will programmatically create namespaces using OpenShift GitOps and
  ApplicationSets. It expects OpenShift GitOps is already installed. It consists
