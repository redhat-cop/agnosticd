= ocp4_workload_rhods_self_managed - Deploy the SElf Managed Data Science operator

== Role overview

* This role deploys the Data Science self-managed service operator. It consists of
