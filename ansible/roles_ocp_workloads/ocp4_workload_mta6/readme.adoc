= ocp4_workload_mta6 - Deploy Migration Toolkit for Applications to an OpenShift Cluster

== Role overview

* This role installs MTA into an OpenShift Cluster.
...
** Tasks: workload.yml - Used to deploy MTA
...
*** This role removes MTA and its subscription.
