...
Manage user access to shared labs clusters by creating a cluster role binding for self-provisioner access and a cluster resource quota to control resource consumption.
