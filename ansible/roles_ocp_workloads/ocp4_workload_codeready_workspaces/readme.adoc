= ocp4_workload_codeready_workspaces - Deploy CodeReady Workspaces to an OpenShift Cluster

== Role overview

* This role installs CodeReady Workspaces into an OpenShift Cluster. It consists of the following tasks files:
** Tasks: link:./tasks/pre_workload.yml[pre_workload.yml] - Sets up an
 environment for the workload deployment.
*** Debug task will print out: `pre_workload Tasks completed successfully.`

** Tasks: link:./tasks/workload.yml[workload.yml] - Used to deploy CodeReady Workspaces
*** This role creates a namespace (project) and deploys the operator. It will then optionally create the CheCluster object that deploys CodeReady Workspaces.
...
** Tasks: link:./tasks/remove_workload.yml[remove_workload.yml] - Used to
 delete the workload
*** This role removes CodeReady Workspaces
