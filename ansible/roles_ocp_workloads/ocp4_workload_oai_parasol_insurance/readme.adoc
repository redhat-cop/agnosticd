= ocp4_workload_oai_parasol_insurance - Configuration to setup OpenShift AI Parasol Insurance Lab workload on OpenShift Cluster.

== Role overview

* This role deploy's the OpenShift AI Insurance Claim Lab workload. It uses GitOps to deploy some applications used in the Lab. 
