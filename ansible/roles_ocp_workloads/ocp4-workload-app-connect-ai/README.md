...
* Camel JBang 4.16
* Kaoto 2.8
* (pending) Red Hat Service Interconnect
* (pending) Red Hat Connectivity Link
...
1. When running with Ansible Playbook (installed on your machine)
    ...
    2. Run Ansible Playbook
        ...
        -e '{"openshift_workloads": [{"name": "ocp4-workload-app-connect-ai"}]}' \
...
ansible/roles_ocp_workloads/ocp4-workload-app-connect-ai/
```
...
<span style="color: #00ff00; text-decoration: underline;">ansible/roles_ocp_workloads/ocp4-workload-app-connect-ai/tasks/provision_streams.yaml</span>
