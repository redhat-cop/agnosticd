= ocp4_workload_lpe_amq_streams - Red Hat Integration - AMQ Streams to OpenShift Latest Product enviorment
...
** Tasks: link:./tasks/remove_workload.yml[remove_workload.yml] - Used to
 delete the workload
*** This role removes the Red Hat Integration - AMQ Broker operator.
...
WORKLOAD="ocp4_workload_amq_broker"
GUID=1001
