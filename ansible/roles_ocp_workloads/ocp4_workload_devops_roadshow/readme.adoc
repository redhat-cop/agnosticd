= ocp4_workload_devops_roadshow - Deploy the assets required to run the DevOps Roadshow Workshop

== Role overview

* Deploys the assets for the DevOps Roadshow Workshop. It consists
