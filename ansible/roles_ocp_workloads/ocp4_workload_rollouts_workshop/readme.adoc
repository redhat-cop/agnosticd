= ocp4_workload_rollouts_workshop - Deploy the assets required to run the Argo Rollouts Workshop

== Role overview

* Deploys the assets for the Argo Rollouts Workshop. It consists
