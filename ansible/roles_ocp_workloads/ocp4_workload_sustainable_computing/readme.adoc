= ocp4_workload_sustainable_computing - Example Workload Role for a Dedicated Cluster
...
** For example, parameters named `ocp4_workload_sustainable_computing_*` would apply to workloads `ocp4-workload-sustainable_computing` itself *and* `ocp4_workload_sustainable_computing_minio`.
...
+
.ocp4_workload_sustainable_computing_vars.yaml
[source,yaml]
----
...
ocp4_workload_sustainable_computing_project_name: "sample-application-{{ ocp_username }}"
----
...
WORKLOAD="ocp4_workload_sustainable_computing"
GUID="1001"
----
...
ansible-playbook -i ${TARGET_HOST}, ./configs/ocp-workloads/ocp-workload.yml \
    ...
    -e"guid=${GUID}" \
    -e"ACTION=create" \
    -e @./ocp4_workload_sustainable_computing_vars.yaml \
    -e @./ocp4_workload_sustainable_computing_secrets.yaml
----
+
...
OCP_USERNAME="wkulhane-redhat.com"
ANSIBLE_USER="ec2-user" # Will become OpenTLC username
WORKLOAD="ocp_workload_sustainable_computing"
GUID="1001"
...
ansible-playbook -i ${TARGET_HOST}, ./configs/ocp-workloads/ocp-workload.yml \
    ...
    -e"guid=${GUID}" \
    -e"ACTION=remove" \
    -e @./ocp_workload_sustainable_computing_vars.yaml \
    -e @./ocp_workload_sustainable_computing_secrets.yaml
----
...
ocp_workload: ocp4_workload_sustainable_computing
...
ocp4_workload_sustainable_computing_project_name: "ocp4-workload-example-{{ ocp_username }}"
...
agnosticv_meta:
  ...
  - ocp4_workload_sustainable_computing_secrets.yml
----
...
ocp4_workload_sustainable_computing_project_name:  "ocp4-workload-example-{{ ocp_username }}-dev"
----
...
# --- Workload Configuration Overrides
ocp4_workload_sustainable_computing_project_name:  "ocp4-workload-example-{{ ocp_username }}-prod"
