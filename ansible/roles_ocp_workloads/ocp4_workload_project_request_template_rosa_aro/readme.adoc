= ocp4_workload_project_request_template_rosa_aro - Create a Project Request Template for Managed Cloud OpenShift
...
WORKLOAD="ocp4_workload_project_request_template_rosa_aro"
GUID=1001
