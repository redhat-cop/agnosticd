= ocp4_workload_mta_tackle - Deploy Konveyer Tackle (Upstream for Migration Toolkit for Applications) to an OpenShift Cluster
...
WORKLOAD="ocp4_workload_mta_tackle"
GUID=1001
