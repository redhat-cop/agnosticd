= ocp4_workload_rhdh - Red Hat Integration - AMQ Streams to OpenShift Latest Product enviorment

== Role overview

* This role installs Red Hat Developer Hub Operator into an OpenShift Cluster. It consists of the following tasks files:
