...
* Other variables:
** *ocp4_workload_rhacm_hypershift_acm_project*: The name of the project where ACM is deployed. Default: `open-cluster-management`
** *ocp4_workload_rhacm_hypershift_acm_release*: ACM release to be deployed. Default: `release-1.0`
** *ocp4_workload_rhacm_hypershift_docker_registry*: ACM Container Registry. Default: `registry.access.redhat.com/rhacm1-tech-preview`
